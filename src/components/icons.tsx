...
// Inline line-icons recreated 1:1 from the design handoff SVGs. The redesign was
// specced against `lucide-react`, but that package is not a dependency here, so
// these dependency-free equivalents carry the exact paths from the prototype.
